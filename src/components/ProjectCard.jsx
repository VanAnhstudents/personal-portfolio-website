        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute top-4 right-4">
            <span
              className={` text-xs px-3 py-1 rounded-full font-medium ${
                isDarkMode ? "bg-gray-800 text-white" : "bg-white/80 text-black"
              } `}
            >
              {project.category}
            </span>
          ...
          >
            <motion.a
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full flex
              items-center space-x-2 text-sm font-medium transition-colors"
            >
