    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            About
            <span className="text-blue-500 font-medium ml-5">Me</span>
          </motion.h2>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                I believe technologies should be a bridge that connects people
                and solves real-world problem. My passion lies in crafting
                digital experiences that are not just functional, but delightful
              ...
              >
                When I'm not coding, you'll fine me exploring new framewoeks,
                contributing to open source, or mentoring aspiring deverlopers.
                I love possibities they bring to create meaningfull digital
                experiences.
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="text-center py-8">
              ...
              <div className="flex justify-center">
                <img src={SIGNATURE} alt="VAnh" className="w-28" />
              </div>
