      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            ...
            className={`absolute top-20 ri-20 w-64 rounded-full blur-3xl opacity-10 ${
          ...
          <div className="block lg:hidden">
            ...
            >
              ...
              >
                ...
                <span className="text-blue-500 font-medium ml-2 mr-2">
                  experiences
                </span>
                <span
                  className={`${isDarkMode ? "text-white" : "text-gray-900"}`}
              ...
              >
                I craft beautiful, function web application with modern
              ...
              >
                ...
                <motion.a
                  ...
                  download
                  className="bg-red-500 hover:bg-red-600 text-white px-8 py-3 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300"
                >
                  Download CV
                </motion.a>
              </motion.div>
          ...
          <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="flex gap-6 mb-8">
                ...
                <motion.a
                  ...
                  href="/src/assets/documents/resume.pdf"
                  download
                  className="bg-red-500 hover:bg-red-600 text-white px-8 py-4 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300"
                >
                  Download CV
                </motion.a>
              </motion.div>
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  variants={itemVariants}
                  className="flex items-center space-x-8 text-xs uppercase tracking-wider absolute -top-40 -left-20"
                >
                  <span
                    className={isDarkMode ? "text-gray-600" : "text-gray-500"}
                  >
                ...
                <motion.div
                  ...
                  className="absolute -inset-8 rounded-3xl border border-pup-500/10"
                ></motion.div>
              </div>
            </motion.div>
          </div>
