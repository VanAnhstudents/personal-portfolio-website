    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.h2
            variants={itemVariants}
            className="text-3xl md:text-5xl font-light mb-5"
          >
            Recent
          ...
          >
            A collection of projects that show case my expertise in building
            modern web application ans solving complex problems.
          </motion.p>
        </motion.div>
